...
public class Tclass extends ServerResource {
    ...
    public List<List> filterTrain(String Lclass) throws ClassNotFoundException, SQLException {
        ...
        ResultSet res = stmt.executeQuery("SELECT * FROM trains WHERE travelClass = '" + Lclass + "'");
